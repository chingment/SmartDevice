...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyRecyclerViewAdapter(Context context, List<String> list, HashMap<String, LockerBoxBean> boxs) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (box != null) {
            ...
            if (box_IsUsed.equals("0")) {
                tv_Box.setBackgroundResource(R.drawable.locker_box_status_1);
            } else {
                tv_Box.setBackgroundResource(R.drawable.locker_box_status_2);
            }
        }
