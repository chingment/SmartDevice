...
public class BookerBorrowReturnFlowService  extends Service {

    private static String TAG = "BookerBorrowReturnFlowService";
    ...
    private FlowBinder mFlowBinder = null;

    @Override
    public void onCreate() {
        LogUtil.d(TAG, "onCreate...");

        mFlowBinder = new FlowBinder();
    }
    ...
    public class FlowBinder extends Binder {
        ...
        public void onOpen(DeviceVo device, BookerSlotVo slot, String flowId) {
