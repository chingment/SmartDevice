...
public class DialogSmConfirm extends Dialog {
    private static final String TAG = "DialogSmConfirm";
    private DialogSmConfirm mThis;
    ...
    public DialogSmConfirm(Context context, String tips, boolean isCancle) {
