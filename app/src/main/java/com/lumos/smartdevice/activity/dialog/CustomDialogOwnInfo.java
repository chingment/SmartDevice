...
public class CustomDialogOwnInfo extends Dialog {

    private static final String TAG = "CustomDialogOwnInfo";
    ...
    public CustomDialogOwnInfo(Context context) {
        super(context, R.style.custom_dialog);
        mThis = this;
        mContext = (BaseFragmentActivity)context;
        mLayoutRes = LayoutInflater.from(context).inflate(R.layout.custom_dialog_owninfo, null);
