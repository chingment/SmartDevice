...
public class CustomDialogSmOwnInfo extends Dialog {

    private static final String TAG = "CustomDialogSmOwnInfo";
    ...
    public CustomDialogSmOwnInfo(Context context) {
        super(context, R.style.custom_dialog);
        mThis = this;
        mContext = (BaseFragmentActivity)context;
        mLayoutRes = LayoutInflater.from(context).inflate(R.layout.custom_dialog_sm_owninfo, null);
        ...
        btn_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RopOwnSaveInfo rop = new RopOwnSaveInfo();
                ...
                ReqInterface.getInstance(version_mode).ownSaveInfo(rop, new ReqHandler() {
    ...
    public  interface OnClickListener{
        void onSaveResult(ResultBean<RetOwnSaveInfo> result);
    }
