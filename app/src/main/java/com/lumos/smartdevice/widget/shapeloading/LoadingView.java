package com.lumos.smartdevice.widget.shapeloading;
...
public class LoadingView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mShapeLoadingView = (ShapeLoadingView) findViewById(R.id.shapeloading_View);
        mIndicationIm = (ImageView) findViewById(R.id.img_Indication);
        mLoadTextView = (TextView) findViewById(R.id.txt_PromptTV);
